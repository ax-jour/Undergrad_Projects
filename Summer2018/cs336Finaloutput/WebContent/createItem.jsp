...
<body onload="getType()">
 <div>
  <form action="newitem.jsp" method="post">
    ...
    <br/> Set your auction:
    <table>
	<tr><td>Start Time</td><td><input type="text"  name="startTime"/>* ()must be in form of yyyy-mm-dd hh:mm:se</td></tr>
	<tr><td>End Time</td><td><input type="text"  name="endTime"/>* ()must be in form of yyyy-mm-dd hh:mm:se</td></tr>
	<tr><td>Reserve Price</td><td><input type="text"  name="reversePrice"/>*</td></tr>
